document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        zh: {
            ...
            cat_wet: "湿碾机",
            btn_more: "更多 +",
            about_title: "赋掣机械以卓越连接市场",
            about_subtitle: "成立于2005年，深耕矿山机械领域二十载",
            about_p1: "赋掣机械是一家领先的 “设备制造与国际贸易的企业”，致力于提供高品质的采矿、破碎和筛分设备。公司总部占地面积超过50,000平方米，拥有现代化的生产线和专业的研发团队。",
            ...
            price_inquiry: "询价",
            recom_title: "产品推荐",
            recom_subtitle: "公司生产的产品有矿用球磨机、金矿专用湿碾机，各种破碎机、磁选机、浮选机、等矿业系列设备。",
            prod_ball_mill: "球磨机",
            prod_rotary_kiln: "破碎机",
            prod_mag_sep: "湿碾机",
            prod_sand_maker: "分级设备",
            btn_consult: "产品咨询",
            desc_ball_mill: "高效研磨，结构稳固，节能效果显著，广泛适用于各种金属矿与非金属矿的细磨作业。",
            desc_rotary_kiln: "包括颚式破碎机，锤式破碎机，对辊破碎机等，适用于各种硬质矿石的粗碎，细碎。",
            desc_mag_sep: "高效湿磨，结构坚固耐用，专为金矿及其他贵金属矿设计，研磨与浸出同步进行。",
            desc_sand_maker: "包括振动筛，螺旋分级机，磁选机等对矿石进行筛分，分级实效率高，回收率好。"
        },
        en: {
            nav_home: "Home",
            ...
            btn_more: "More +",
            about_title: "FUCHE Machinery Connects Markets with Excellence",
            about_subtitle: "Founded in 2005, deep cultivation in the field of mining machinery for twenty years",
            about_p1: "FUCHE Machinery is a leading enterprise in equipment manufacturing and international trade, dedicated to providing high-quality mining, crushing, and screening equipment. The company headquarters covers an area of more than 50,000 square meters, with modern production lines and a professional R&D team.",
            ...
            recom_subtitle: "Our products include mining ball mills, specialized wet pan mills for gold mines, and various series of mining equipment such as crushers, magnetic separators, and flotation machines.",
            prod_ball_mill: "Ball Mill",
            prod_rotary_kiln: "Crusher",
            prod_mag_sep: "Wet Pan Mill",
            prod_sand_maker: "Separation Equipment",
            btn_consult: "Consultation",
            desc_ball_mill: "High-efficiency grinding, stable structure, significant energy saving, suitable for fine grinding of various ores.",
            desc_rotary_kiln: "Including jaw crushers, hammer crushers, and roll crushers, suitable for coarse and fine crushing of hard ores.",
            desc_mag_sep: "High-efficiency wet grinding, durable structure, specially designed for gold and precious metal mines.",
            desc_sand_maker: "Including vibrating screens, flotation machines, and magnetic separators for ore screening and grading."
        },
        ar: {
            ...
            cat_wet: "مطحنة الرطب",
            btn_more: "المزيد +",
            about_title: "فوتشي للآلات تربط الأسواق بالتميز",
            about_subtitle: "تأسست في عام 2005، ولها جذور عميقة في مجال آلات التعدين لمدة عشرين عاماً",
            about_p1: "فوتشي للآلات هي مؤسسة رائدة في \"تصنيع المعدات والتجارة الدولية\"، مكرسة لتوفير معدات التعدين والتكسير والغربلة عالية الجودة. يغطي مقر الشركة مساحة تزيد عن 50,000 متر مربع، مع خطوط إنتاج حديثة وفريق بحث وتطوير محترف.",
            ...
            recom_subtitle: "تشمل منتجاتنا مطاحن الكرات التعدينية، ومطاحن الرطب المتخصصة لمناجم الذهب، ومجموعات متنوعة من معدات التعدين مثل الكسارات والفواصل المغناطيسية وآلات التعويم.",
            prod_ball_mill: "مطحنة الكرة",
            prod_rotary_kiln: "كسارة",
            prod_mag_sep: "مطحنة الرطب",
            prod_sand_maker: "معدات التصنيف",
            btn_consult: "استشارة",
            desc_ball_mill: "طحن عالي الكفاءة، هيكل مستقر، توفير كبير في الطاقة، مناسب للطحن الناعم لمختلف الخامات.",
            desc_rotary_kiln: "بما في ذلك الكسارات الفكية والكسارات المطرقة والكسارات الأسطوانية، مناسبة للسحق الخشن والناعم للخامات الصلبة.",
            desc_mag_sep: "طحن رطب عالي الكفاءة، هيكل متين، مصمم خصيصاً لمناجم الذهب والمعادن الثمينة.",
            desc_sand_maker: "بما في ذلك الغرابيل الاهتزازية وآلات التعويم والفواصل المغناطيسية لغربلة وتصنيف الخام بكفاءة عالية."
        }
    };
